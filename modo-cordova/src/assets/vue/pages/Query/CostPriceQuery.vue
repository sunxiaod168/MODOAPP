<template>
  ...
  <f7-page nav-title="成本价格查询" pull-to-refresh infinite-scroll @page:beforeinit="initHandle" @page:back="backHandler" @ptr:refresh="onRefresh" @infinite="onInfiniteScroll">
        ...
        <li class="accordion-item" v-for="item in priceList">
          <a href="#" class="item-content item-link">
            <div class="item-inner">
              ...
              <span>
                <i class="fas fa-yen-sign"></i>{{item.CostPrice}}</span>
            </div>
          </a>
...
import Right from "./components/CostPriceQueryRight";
